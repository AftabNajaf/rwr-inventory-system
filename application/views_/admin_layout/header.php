  ...
  <div class="sidemenu-container navbar-collapse collapse fixed-menu">
    <div id="remove-scroll">
      <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
        ...
        <?php 	$privileges = 	$this->AdminModel->getRow('e_admin',array('userid'=>$this->session->userid));
				$dutiez		=	explode(',',$privileges['privileges']);
		?>
        ...
        <?php if(in_array('reqs', $dutiez)  || $this->session->role=='admin'):?>
        <li class="nav-item <?php if(@strpos("reqs",$function )!== false){echo 'active';}?>"> 
        	<a href="<?=base_url()?>Home/reqs" class="nav-link "> 
            	<i class="material-icons">payment</i> <span class="title">Store Requests</span> </a> </li>
        <?php endif ?>            
        <?php if(in_array('items', $dutiez)  || in_array('itemqty', $dutiez)  || in_array('itemcustody', $dutiez)  ||$this->session->role=='admin'):?>
        <li class="nav-item  <?php if(@strpos("items,itemqty,itemcustody",$function )!== false){echo 'active';}?> "> 
            	<a href="#" class="nav-link nav-toggle"> 
          		...
          		<ul class="sub-menu">
                	<?php if(in_array('items', $dutiez) ||$this->session->role=='admin'):?>
        ...
        <?php endif ?>    
        <?php if(in_array('bom', $dutiez)  || $this->session->role=='admin'):?>
		...
		<?php endif ?> 	
        <?php if(in_array('bmlib', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>
        <?php if(in_array('mat', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>
        <?php if(in_array('po', $dutiez)  || in_array('pol', $dutiez)  || $this->session->role=='admin'):?>
        <li class="nav-item  <?php if(@strpos("po,pol",$function )!== false){echo 'active';}?> ">
            	<a href="#" class="nav-link nav-toggle"> 
          		...
          		<ul class="sub-menu">
               		<?php if(in_array('po', $dutiez)  ||  $this->session->role=='admin'):?>
                    ...
                    <?php endif ?>
                    <?php if(in_array('pol', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>
        <?php if(in_array('grn', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>    
        <?php if(in_array('advbooking', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>	
        <?php if(in_array('release', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>	
        <?php if(in_array('relreqbyuser', $dutiez)  || $this->session->role=='admin'):?>
        <li class="nav-item <?php if(@strpos("relreqbyuser",$function )!== false){echo 'active';}?>"> 
            	<a href="<?=base_url()?>Home/relreqbyuser" class="nav-link ">
                	<i class="material-icons">content_paste</i><span class="title">Rel.Req. By User</span></a>
            </li>
        <?php endif ?>	
        <?php if(in_array('tempissue', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>    
        <?php if(in_array('restock', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>     
        <?php if(in_array('dc', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>    
        <?php if(in_array('mmov', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>
        <?php if(in_array('mmbyuser', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>     
        <?php if(in_array('fixed', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>    
        <?php if(in_array('settings', $dutiez)  || in_array('users', $dutiez)  || in_array('suppliers', $dutiez)  || in_array('customers', $dutiez)  || in_array('departments', $dutiez)  || in_array('projects', $dutiez)  || in_array('categories', $dutiez)  || in_array('units', $dutiez)  || in_array('rwrdata', $dutiez)  || in_array('elogs', $dutiez)  || $this->session->role=='admin'):?>
        <li class="nav-item <?php if(@strpos("settings,users,suppliers,customers,departments,projects,categories,units,rwrdata,elogs",$function )!== false){			echo 'active';}?> "> 
                ...
                <i class="material-icons">ac_unit</i> <span class="title">Configurations</span> <span class="arrow"></span> </a>
          		<ul class="sub-menu">
            		<?php if(in_array('settings', $dutiez)  || $this->session->role=='admin'):?>
            		...
            		<?php endif ?>   
					<?php if(in_array('units', $dutiez)  || $this->session->role=='admin'):?>
            		...
            		<?php endif ?>   
					<?php if(in_array('categories', $dutiez)  || $this->session->role=='admin'):?>
            		...
            		<?php endif ?>   
					<?php if(in_array('departments', $dutiez)  || $this->session->role=='admin'):?>
            		...
            		<?php endif ?>   
					<?php if(in_array('projects', $dutiez)  || $this->session->role=='admin'):?>
            		...
            		<?php endif ?>   
					<?php if(in_array('suppliers', $dutiez)  || $this->session->role=='admin'):?>
            		...
            		<?php endif ?>   
					<?php if(in_array('customers', $dutiez)  || $this->session->role=='admin'):?>
                    ...
                    <?php endif ?>   
					<?php if(in_array('users', $dutiez)  || $this->session->role=='admin'):?>
                    ...
                    <?php endif ?>   
					<?php if(in_array('rwrdata', $dutiez)  || $this->session->role=='admin'):?>
                    ...
                    <?php endif ?>   
					<?php if(in_array('elogs', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?>     
        <?php if(in_array('feedbackform', $dutiez)  || $this->session->role=='admin'):?>
        ...
        <?php endif ?> 
        <?php if(in_array('feedbackrpt', $dutiez)  || $this->session->role=='admin'):?>
