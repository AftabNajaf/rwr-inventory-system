...
$key = "id";
$tableName = "e_items";
$fields = array('Request #','Project','Assembly','Sub-Assembly','Generated By','Status');//,'Parent Category'
$indexes  = array('id','project_id','assembly_id','sub_assembly_id','generated_by','approved_status');//,'parentid'
        ...
        <div class="card card-topline-aqua">
		  ...
		  <style>#saveXStage tr th {padding:0px; text-align:center; height:20px}</style>    
            <table id="saveXStage" class="table table-bordered display full-width" >
                ...
                <th width="10%">
                <button class="btn btn-info btn-xs" onclick="setStoreRemarksUser2(<?=$bom['id']?>,'release','e_releaseitems','e_release',<?=$bom['id']?>,'adv_id')" >Mark as Done</button>
                </th></tr>
		  ...
		  if($bomi){
			  foreach($bomi as $bi){ extract($bi);?>
                ...
                <td width="10%"><?=getField('e_items_alloc',array("instrument_no"=>$bom['id'],'instrument'=>"release","item_id"=>$item_id),'item_quantity');?></td>
                ...
                <?php if($this->session->role!='level1' || $bom['approved_status']!='Approved') :?>
                  <!--<button class="btn btn-danger btn-xs" onclick="deletBomItem('id',<?=$id?>,'e_releaseitems')"> <i class="fa fa-trash-o "></i></button>-->
                  <?php endif?>
                 <button class="btn btn-success btn-xs" onclick="addEditItemAlloc('add',<?=$bom['id']?>,<?=$item_id?>,'release')" > <i class="fa fa-gear"></i>Alloc. Item</button>
