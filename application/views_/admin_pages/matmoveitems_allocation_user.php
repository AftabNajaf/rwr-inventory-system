...
#saveXStage tr th {padding:0px; text-align:center; height:20px}
              ...
              <table id="saveXStage" class="table table-bordered display full-width" >
                <tr>
                  ...
                  <th width="10%">
                  <button class="btn btn-info btn-xs" onclick="setStoreRemarksUser(<?=$bom['id']?>,'mmov','e_mmitems','e_mm',<?=$bom['id']?>,'adv_id')" >Mark as Done</button>
                  </th>
                </tr>
		  ...
		  if($bomi){
              ...
              <td width="10%"><?=$item_id?></td>
                <td width="35%"><span onclick="idetailsToolTip(<?=$item_id?>)" onclick="clearToolTip(<?=$item_id?>)">
