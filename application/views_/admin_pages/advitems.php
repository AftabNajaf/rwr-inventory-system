...
#saveXStage tr th {padding:0px; text-align:center; height:20px}
            ...
            <form name="myForm" id="myForm" method="post" enctype="multipart/form-data"  onsubmit="return form_validation()">
              ...
              <input type="hidden" value="e_advitems" id="tableName" name="tableName">
              ...
              <table id="saveXStage" class="table table-bordered display full-width" >
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control default_dtpp" name="req_date" id="req_date" required ></td>
		  ...
		  if($bomi){
              ...
              <tr id="row<?=$id?>">
                ...
                <td><button class="btn btn-primary btn-xs" onclick="updateitem(<?=$id?>,'e_advitems',<?=$item_id?>)" > <i class="fa fa-pencil"></i></button>
