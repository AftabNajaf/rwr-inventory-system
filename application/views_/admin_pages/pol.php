...
$key = "id";
$tableName = "e_items";
$fields = array('mis_no','mat_id','generated_by','department_id', 'section_id','project_id','assembly_id','sub_assembly_id','qty_needed','issue_quantity', 'req_quantity');
$indexes  = array('mis_no','mat_id','generated_by','department_id', 'section_id','project_id','assembly_id','sub_assembly_id','qty_needed','issue_quantity', 'req_quantity');
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-topline-aqua">
          <div class="card-head">
            <header><small class="sub-heading"><a href="<?=base_url()?>Home/pol"> Urgent POL </a></small> &nbsp;&nbsp;<small class="sub-heading"><a href="<?=base_url()?>Home/polall"> POL </a></small></header>
...
scrollX: true,
        ...
        ajax: "<?=base_url()?>Function_control/getPOL2"
    });
