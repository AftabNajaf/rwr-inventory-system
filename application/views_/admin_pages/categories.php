...
<?php 
$pageName = "categories";
$calledName = "Categories";
$heading = "Categories";
$key = "id";
$tableName = "e_categories";
      ...
      <div class="col-md-8">
        <div class="card card-topline-aqua">
          ...
          <!--<span class="context-menu-one btn btn-neutral">right click me</span>-->
                ...
                <button class="btn btn-danger btn-sm" onclick="deleteRecord('id',<?=$id?>,'<?=$tableName?>')"><i class="fa fa-trash "></i></button>
                <button class="btn btn-primary btn-sm" onclick="add('edit',<?=$id?>)" ><i class="fa fa-pencil"></i></button>
                 <?php endif ?>
