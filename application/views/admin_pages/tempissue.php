...
$key = "id";
$tableName = "e_items";
$fields = array('Req #','Department','Section','Project','Generated On','Generated By','Status');//,'Parent Category'
...
<div class="page-content-wrapper">
  ...
  '<?=base_url()?>Pdfgenerator/downloadTempIssue/<?=$row[$key]?>',
  '_blank')" >
                                <i class="fa fa-eye"></i></button>
                                	
                                    <?php if(($row['store_remarks']!='Completed' && $row['store_remarks']!='') && $row['bom_remarks'] =='') :?>
                                    <button class="btn btn-primary btn-xs" onclick="setReceivings('e_tempissue','<?=$row['generated_by']?>','id',<?=$row[$key]?>)" >
                                ...
                                <button class="btn btn-success btn-xs" onclick="location.href='<?=base_url()?>Home/tmpissueitems/<?=$row[$key]?>'">
                                <i class="fa fa-plus"> Items</i></button>
                                <button class="btn btn-primary btn-xs" onclick="addbom('edit',<?=$row[$key]?>)" >
                                <i class="fa fa-pencil"></i></button>
                                <button class="btn btn-danger btn-xs" onclick="deleteRecordx('<?=$key?>',<?=$row[$key]?>,'e_tempissue')">
