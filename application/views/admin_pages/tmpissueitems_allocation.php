...
#saveXStage tr th {padding:0px; text-align:center; height:20px}
              ...
              <table id="saveXStage" class="table table-bordered display full-width" >
                <tr>
                  ...
                  <th width="10%">
                  <button class="btn btn-info btn-xs" onclick="setStoreRemarks(<?=$bom['id']?>,'tmpissue','e_tempissueitems','e_tempissue',<?=$bom['id']?>,'adv_id')" >Mark as Done</button>
                  </th>
                </tr>
		  ...
		  if($bomi){
              ...
              <tr id="row<?=$id?>">
                ...
                <td width="15%">
                	<span onclick="idetailsToolTip(<?=$item_id?>)" onclick="clearToolTip(<?=$item_id?>)">
                  <?=getField('e_items',array("id"=>$item_id),'item_name');?>
                  </span></td>
                <td width="10%"><?=$qty_needed?></td>
                <td width="15%"><?=$req_date?></td>
                <td width="10%"><?=$item_notes?></td>
                <td width="10%"><?=getField('e_items_alloc',array("instrument_no"=>$bom['id'],"item_id"=>$item_id,"instrument"=>'tmpissue'),'item_quantity');?></td>
                ...
                <td>
                  ...
                  <?php endif?>
                  <button class="btn btn-success btn-xs" onclick="addEditItemAlloc('add',<?=$bom['id']?>,<?=$item_id?>,'tmpissue')" > <i class="fa fa-gear"></i>Alloc. Item</button>
