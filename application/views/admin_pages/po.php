...
$key = "id";
$tableName = "e_po";
$fields = array('PO #','Supplier','Generated On','Status');//,'Parent Category'
$indexes  = array('id','supplier_id','generated_on','approved_status');//,'parentid'
...
<div class="page-content-wrapper">
          ...
          <div class="card-head">
           ...
           <?php  $privileges=$this->session->privileges; 
			if(strpos($privileges,'bomcreate')!==false):?>
              <button type="button" class="btn btn-round btn-warning" onclick="addpo('add',0)" >Add New</button>
              <?php endif?>
            </div>
            <div class="tools">
  ...
  '<?=base_url()?>Pdfgenerator/downloadPO/<?=$row[$key]?>',
  '_blank')" >
                                <i class="fa fa-eye"></i></button>
                                <?php else:?>
                                <button class="btn btn-success btn-xs" onclick="location.href='<?=base_url()?>Home/poitems/<?=$row[$key]?>'">
  ...
  '_blank')" >
                                ...
                                <i class="fa fa-pencil"></i></button>
                                 ...
                                 <button class="btn btn-danger btn-xs" onclick="deleteRecordx('<?=$key?>',<?=$row[$key]?>,'e_po')">
