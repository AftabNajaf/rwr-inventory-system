...
#saveXStage tr th {padding:0px; text-align:center; height:20px}
            ...
            <form name="myForm" id="myForm" method="post" enctype="multipart/form-data"  onsubmit="return form_validation()">
              ...
              <input type="hidden" value="e_poitems" id="tableName" name="tableName">
              <input type="hidden" value="id" id="keyIndex" name="keyIndex">
              <input type="hidden" value="0" id="id" name="id">
              <input type="hidden" value="add" id="action" name="action">
              <input type="hidden" class="form-control" name="po_id" id="po_id" value="<?=$bom['id']?>" required >
              <table id="saveXStage" class="table table-bordered display full-width" >
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control" name="supplier_ref" id="supplier_ref" disabled="disabled"  ></td>
                  <td><input type="text" class="form-control" name="part_number" id="part_number" disabled="disabled"  ></td>
                  <!--<td><input type="text" class="form-control" name="item_description" id="item_description" required ></td>-->
		  ...
		  if($bomi){
              ...
              <tr id="row<?=$id?>">
                <td width="40%"><span onclick="idetailsToolTip(<?=$item_id?>)" onclcik="clearToolTip(<?=$item_id?>)">
                ...
                <td>
                  <button class="btn btn-primary btn-xs" onclick="updateitem(<?=$id?>,'e_poitems')" > <i class="fa fa-pencil"></i></button>
                 
                <?php if($this->session->role!='level1' || $bom['approved_status']!='Approved') :?>
                  <button class="btn btn-danger btn-xs" onclick="deletPoItem('id',<?=$id?>,'e_poitems')"> <i class="fa fa-trash-o "></i></button>
                  <?php endif?>
