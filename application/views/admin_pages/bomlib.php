...
$key = "id";
$tableName = "e_items";
$fields = array('BOM #','Department','Section','Project','Generated On','Status');//,'Parent Category'
$indexes  = array('id','department_id','section_id','project_id','generated_on','approved_status');//,'parentid'
