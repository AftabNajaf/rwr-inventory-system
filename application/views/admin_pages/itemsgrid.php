...
$key = "REFERENCE_NO";
$tableName = "table38";
$fields = array('ASAD_ID', 'REFERENCE_NO', 'PARENT_ID', 'ITEM_CATEGORY_NAME', 'cpath', 'category', 'catid');
$indexes  = array('ASAD_ID', 'REFERENCE_NO', 'PARENT_ID', 'ITEM_CATEGORY_NAME', 'cpath', 'category', 'catid');
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-topline-aqua">
          ...
          <div class="card-body ">
            <table id="saveStagexx" class="table-bordered display full-width" >
              <thead>
                <tr>
              ...
              <tbody>
						<?php foreach ($data as $row):?>
                        	<tr id="row<?=$row[$key]?>">
								...
								if($index=='cpath')
									$row[$index]=$this->AdminModel->getCatPath($row['PARENT_ID']);
