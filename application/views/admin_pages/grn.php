...
$heading = "Goods Receive Notes - GRN";
$key = "id";
$tableName = "e_po";
$fields = array('PO #','Supplier','Generated On','PO Status');//,'Parent Category'
        ...
        <div class="card card-topline-aqua">
          <div class="card-head">
            ...
            <button  style="display:none" type="button" id="btn_popup" value="ppp"></button><!---->
              <button type="button" class="btn btn-round btn-warning" onclick="addpo('add',0)" >Add Local Purchase(s)</button>
            </div>
            <div class="tools">
