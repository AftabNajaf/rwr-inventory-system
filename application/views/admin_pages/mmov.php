...
$key = "id";
$tableName = "e_items";
$fields = array('MM #','Ask From','Generated On','Generated by','Status');//,'Parent Category'
$indexes  = array('id','askfrom','generated_on','generated_by','approved_status');//,'parentid'
...
<div class="page-content-wrapper">
              ...
              <tbody>
						<?php foreach ($boms as $row):?>
                        	<tr id="row<?=$row[$key]?>">
								...
								if($index=='askfrom' && $row[$index]==0) $row[$index]='Store';
								elseif($index=='askfrom' && $row[$index]>0)
  ...
  '_blank')" >
                               ...
                               <?php if($row['store_remarks']!='' && $row['bom_remarks']=='' && $this->session->role=='level1') :?>
                                    <button class="btn btn-primary btn-xs" onclick="setReceivings('e_mm','<?=$row['generated_by']?>','id',<?=$row[$key]?>)" >
                                <i class="fa fa-gear"> Receivings</i></button>
                                    <?php endif?>
