...
$key = "id";
$tableName = "e_logs";
$fields = array('Action', 'Table', 'Instrument', 'Row ID', 'MIS#', 'Statment', 'User', 'Date');//,'Parent Category'
$indexes  = array('action', 'tbl_name', 'instrument', 'record_id', 'mis_no', 'qry_statment', 'userid', 'createdon');//,'parentid'
       ...
       // processing: true,
        ...
        stateSave: true,
          stateSaveCallback: function(settings,data) {
              localStorage.setItem( 'xpetbl_' + settings.sInstance, JSON.stringify(data) )
            },
          stateLoadCallback: function(settings) {
            return JSON.parse( localStorage.getItem( 'xpetbl_' + settings.sInstance ) )
            },
		dom: 'Bfrtip',
        buttons: [
        ...
        ajax: "<?=base_url()?>Function_control/getLogs"
    });
