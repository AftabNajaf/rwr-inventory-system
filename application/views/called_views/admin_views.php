...
feedbackform,feedbackrpt--><?php */?>
      ...
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label">
        <input class="form-check-input" type="checkbox"  name='privileges[]' value="users" <?php if(in_array('users',$privileges)) echo 'checked' ?>> Manage Users
        </label>
      </div>
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label">
        <input class="form-check-input" type="checkbox"  name='privileges[]' value="rwrdata" <?php if(in_array('rwrdata',$privileges)) echo 'checked' ?>> Data Management
        </label>
      </div>
      </div>
