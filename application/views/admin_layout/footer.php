...
function setStoreRemarks(tid,tblName,tblxi,tblx,rowkey,tblxi_id){
	...
	$.post("<?php echo base_url(); ?>Function_control/setStoreRemarks",{tid,tblName,tblxi,tblx,rowkey,tblxi_id}, 
		function(data)
		{  	//alert(data);
			//location.reload();
			window.location.href = "<?php echo base_url(); ?>Home/reqs";

		});
}

function setStoreRemarksUser(tid,tblName,tblxi,tblx,rowkey,tblxi_id){
	
	$.post("<?php echo base_url(); ?>Function_control/setStoreRemarks",{tid,tblName,tblxi,tblx,rowkey,tblxi_id,rowkey,tblxi_id}, 
		function(data)
		{  	//alert(data);
			window.location.href = "<?php echo base_url(); ?>Home/mmbyuser";

		});
}

function setStoreRemarksUser2(tid,tblName,tblxi,tblx,rowkey,tblxi_id){
	
	$.post("<?php echo base_url(); ?>Function_control/setStoreRemarks",{tid,tblName,tblxi,tblx,rowkey,tblxi_id,rowkey,tblxi_id}, 
		function(data)
		{  	//alert(data);
			window.location.href = "<?php echo base_url(); ?>Home/relreqbyuser";
...
document.getElementById("searchcat").addEventListener("keydown",function(event){
if(event.keyCode===13){
