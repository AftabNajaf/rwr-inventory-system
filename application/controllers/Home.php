...
public function cleanDB() {
        ...
        $this->db->truncate('e_bom');
        $this->db->truncate('e_bomitem');
        $this->db->truncate('e_dc');
        $this->db->truncate('e_dcitems');
        $this->db->truncate('e_items');
        $this->db->truncate('e_items_alloc');
        $this->db->truncate('e_items_qty');
        $this->db->truncate('e_logs');
        $this->db->truncate('e_mat');
        $this->db->truncate('e_matitem');
        $this->db->truncate('e_po');
        $this->db->truncate('e_poitems');
        $this->db->truncate('e_restock');
        $this->db->truncate('e_restockitems');
        $this->db->truncate('e_tempissue');
        $this->db->truncate('e_tempissueitems');

        // Output success response
        echo json_encode(array('status' => 'success', 'message' => 'Database tables truncated successfully.'));
    }
}
