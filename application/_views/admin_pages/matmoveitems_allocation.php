...
#saveXStage tr th {padding:0px; text-align:center; height:20px}
		  ...
		  if($bomi){
              ...
              <tr id="row<?=$id?>">
                <td width="45%"><span onclick="idetailsToolTip(<?=$item_id?>)" onclick="clearToolTip(<?=$item_id?>)">
                ...
                <td width="10%"><?=getField('e_items_alloc',array("instrument_no"=>$bom['id'],"item_id"=>$item_id,"instrument"=>"mmov"),'item_quantity');?></td>
                ...
                <td>
                  ...
                  <?php endif?>
                  <button class="btn btn-success btn-xs" onclick="addEditItemAlloc('add',<?=$bom['id']?>,<?=$item_id?>,'mmov')" > <i class="fa fa-gear"></i>Alloc. Item</button>
