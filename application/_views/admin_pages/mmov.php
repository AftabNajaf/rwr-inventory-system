...
$key = "id";
$tableName = "e_items";
$fields = array('MM #','Title/Name','Generated On','Generated by','Status');//,'Parent Category'
$indexes  = array('id','mm_title','generated_on','generated_by','approved_status');//,'parentid'
