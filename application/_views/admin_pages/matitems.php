    ...
    <div class="row">
      ...
      <form name="myForm" id="myForm" method="post" enctype="multipart/form-data"  onsubmit="return form_validation()">
            ...
            <table id="saveXStage" class="table table-bordered display full-width" >
                <tr><th width="20%">Assembly</th>
                <th width="20%">Sub Assembly</th>
                ...
                <td>
                <span  class="form-control" name="itm_display" id="itm_display" onclick="searchSelectItem()">Click to Select Item</span>
                <input type="hidden" class="form-control" name="item_id" id="item_id" placeholder="select Item" required >
                </td>
		  ...
		  if($bomi){
			  foreach($bomi as $bi){ extract($bi);?>
                <tr id="row<?=$id?>">
                <td width="20%"><?=getField('e_assemblies',array("id"=>$assembly_id),'title');?></td>
                <td width="20%"><?=getField('e_assemblies',array("id"=>$sub_assembly_id),'title');?></td>
                <td width="20%"><span onclick="idetailsToolTip(<?=$item_id?>)"><?=$item_id.'-'.getField('e_items',array("id"=>$item_id),'item_name');?></span> </td>
                <td width="10%"><?=$qty_needed?></td>
                <td width="20%"><?=$item_notes?></td>
                <td>
                <button class="btn btn-primary btn-xs" onclick="updateitem(<?=$id?>,'e_matitem')" >
