...
$heading = "Material Movement";
$key = "id";
$tableName = "e_items";
$fields = array('MM #','DC Date','Sale No','Customer','Carrier','Generated On','Status');//,'Parent Category'
...
<div class="page-content-wrapper">
  ...
  '<?=base_url()?>Pdfgenerator/downloadMaterialMovement/<?=$row[$key]?>',
  '_blank')" >
