...
<?php 
$pageName = "itemqty";
$calledName = "FixedAssets";
$heading = "Fixed Assets Evaluations";
$key = "id";
$tableName = "e_items";
$fields = array('Ser #','Period','Generated On','Status');//,'Parent Category'
$indexes  = array('id','period','generated_on','approved_status');//,'parentid'
              ...
              <tbody>
						<?php foreach ($boms as $row):?>
                        	<tr id="row<?=$row[$key]?>">
                                ...
                                <button class="btn btn-success btn-xs" onclick="location.href = '<?=base_url()?>Home/fixeditems/<?=$row[$key]?>'" >
...
{   var viewType 	= 'FixedAssets';
	var tableName 	= 'e_fixed';
	var key 		= 'id'; 
	$("#exTitle").html(action+' Fixed Assets Evaluation');
