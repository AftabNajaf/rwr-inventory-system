...
$heading = "Mat.Movement";
$key = "id";
$tableName = "e_items";
$fields = array('MM #','Title/Name','Generated On','Status', ' --');//,'Parent Category'
$indexes  = array('id','mm_title','generated_on','approved_status','store_remarks');//,'parentid'
...
<div class="page-content-wrapper">
      ...
      <div class="col-md-12">
        <div class="card card-topline-aqua">
          <div class="card-head">
            ...
            <?php if(strpos($privileges,'mmovcreate')!==false):?>
  ...
  '_blank')" >
                                ...
                                <?php if($row['approved_status']=='Approved'&& $this->session->userid==$row['askfrom']) :?>
