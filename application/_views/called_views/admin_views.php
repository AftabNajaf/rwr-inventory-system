...
<form name="myForm" id="myForm" method="post" enctype="multipart/form-data"  onsubmit="return form_validation()">
  ...
  <div class="row">
	...
	<div class="form-group col-md-3">
      ...
      <?php  $privileges = $data['privileges'];// if($data['privileges']!="") $privileges = explode(',', $data['privileges']); else $privileges=array(); ?>
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> BOM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="bom" <?php if(strpos($privileges,'bom')) echo 'checked' ?>> View BOM </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="bomcreate" <?php if(strpos($privileges,'bomcreate')) echo 'checked' ?>> Add New BOM </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> MAT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="mat" <?php if(strpos($privileges,'mat')) echo 'checked' ?>> View MAT </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="matcreate" <?php if(strpos($privileges,'matcreate')) echo 'checked' ?>> Add New MAT </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> PO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="po" <?php if(strpos($privileges,'po')) echo 'checked' ?>> View P.O </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="pocreate" <?php if(strpos($privileges,'pocreate')) echo 'checked' ?>> Add New P.O </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> Adv. Booking &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="adv" <?php if(strpos($privileges,'adv')) echo 'checked' ?>> View Adv Bookings </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="advcreate" <?php if(strpos($privileges,'advcreate')) echo 'checked' ?>> Add New Adv.Booking </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> Releases &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="release" <?php if(strpos($privileges,'release')) echo 'checked' ?>> View Releases </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="releasecreate" <?php if(strpos($privileges,'releasecreate')) echo 'checked' ?>> Add New Releases </label>
      </div>
      
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px;">
        <label class="form-check-label"> Mat. Mov &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="mmov" <?php if(strpos($privileges,'mmov')) echo 'checked' ?>> View MMO </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="mmovcreate" <?php if(strpos($privileges,'mmovcreate')) echo 'checked' ?>> Add New MMO </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> Restock &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="restock" <?php if(strpos($privileges,'restock')) echo 'checked' ?>> View Restock </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="restockcreate" <?php if(strpos($privileges,'restockcreate')) echo 'checked' ?>> Add New Restock </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> Temp. Issue &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="tempissue" <?php if(strpos($privileges,'tempissue')) echo 'checked' ?>> View Temp. Issues </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="tempissuecreate" <?php if(strpos($privileges,'tempissuecreate')) echo 'checked' ?>> Add New Temp. Issue </label>
      </div>
      
      <div class="form-check form-check-inline" style="background-color:#CCC; line-height:20px; padding:5px; margin:5px">
        <label class="form-check-label"> Del. Challan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="dc" <?php if(strpos($privileges,'dc')) echo 'checked' ?>> View Del. Challan </label> &nbsp;&nbsp;&nbsp;
          <label class="form-check-label">
          <input class="form-check-input" type="checkbox"  name='privileges[]' value="dccreate" <?php if(strpos($privileges,'dccreate')) echo 'checked' ?>> Add New Del. Challan </label>
      </div>
...
<form name="myForm" id="myForm" method="post" enctype="multipart/form-data"  onsubmit="return form_validation()">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
        <label>New Parent Node/Category</label>
      ...
      <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
          ...
          <select class="form-control" name="section_id" id="section_id"  >
              <option value="0"></option>
              <?=getOption('e_departments','id','title',$data['section_id'])?>
          </select>
        </div>
        <div class="form-group col-md-3">
          <label>Project</label>
  ...
  <div class="form-group col-md-3">
      ...
      <div class="form-group col-md-3">
        ...
        <select class="form-control" name="parentassembly" id="parentassembly" required >
            <option value="0"></option>
          	<?= getOption('e_assemblies','id','title',$data['parentassembly'])?>
            </select>
    </div>
       <div class="form-group col-md-12">
        <label>Description</label>
...
<form name="allocForm" id="allocForm" method="post" enctype="multipart/form-data"  onsubmit="return form_alloc_validation()">
  ...
  <div class="form-group col-md-2">
    ...
    <!--<div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" value="< ?=$data['item_quantity']?>" disabled   />
    </div>-->
    <div class="form-group col-md-3">
       ...
       <input type="number" id="item_quantity" min="1" name="item_quantity" class="form-control" value="<?=$data['item_quantity']?>" required />
    </div>
   <div class="form-group col-md-3">
...
<form name="myForm" id="myForm" method="post" enctype="multipart/form-data"  onsubmit="return form_validation()">
  ...
  <input type="hidden" value="edit" id="action" name="action">
      ...
      <div class="form-group col-md-3">
        <label class="control-label">Password</label>
        <input type="password" id="passwordxx" name="passwordxx" class="form-control" />
      </div>
       ...
       <div class="form-group col-md-3">
        ...
        <option value="Prending">Pedning</option>        
        </select>
      </div>
